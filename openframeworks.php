...
<body class="body-2">
    ...
    <div class="oF-sec-one">
        ...
        <div class="project-section">
            ...
            <div class="w-container center-button">
    ...
    <div class="oF-sec-one">
        <div class="project-section">
            <div class="w-container">
                ...
                <p>The original goal this project was to create a digital guitar peddle

When discussing this with My team we initially floated the idea of creating a web conferencing tool where musicians could jam over a connection and get real-time feedbackk with the facts and information about how the other teams playing.

We broke the software into portions and my portion became the guitar effects. 

                    While researching how to program distortion I came across a few concepts.</p>
