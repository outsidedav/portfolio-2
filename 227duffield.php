...
<body class="body-2">
    <div>
        ...
        <div class="heading-wrapper w-container">
            ...
            <h1 class="project-page-h1">227 Duffield Street</h1>
            <h2 class="project-page-h2">Abolitionist Place's last Abolitionist Place </h2>
        </div>
    ...
    <div class="project-section">
        <div class="w-container">
            ...
            <p>227 Abolitionist place is historical site from the underground railroad with a rich history in times both modern and past. In the past, it was home to the abolisionist couple the Truesdells, who helped an unknown number of slaves flee to freedom in Canada. In modern times, it belonged to activist Joy Chatel, who succesfully won an eminate domain suite against the city when they wanted to demolish the historical 227 Abolitionist place and build a parking lot. Our class partnered with the Brooklyn Historical Society and 227 Abolitionist place to pitch ideas to the museum of how they can increase awareness of the historical site.</p>

            <p>The goal of this project was to design an interactive experience relates to <em>African-American history</em> of the <em>underground railway</em> located at Duffield St in Brooklyn, New York in an user-centered way. After three months of research, ideation and iterating, we decided to design a way-finding system mixed with a guerilla art project to raise interest of the historical site in Brooklyn Heights</p>
    ...
    <div class="project-section">
        <div class="containter-4 w-container">
            ...
            <div class="p-div-block">
                <p>Research is key to the success of any project, and research lead our project throughout the entire design process. In the beginning, it was essential for us to understand three things: who would our key users be, what brings people to exhibits similar to our clients, and the sensitive history of our site. To do this, we interviewed patrons of two museums near our site visiting a similar exhibit, we interviewed experts and academics about the underground railroad in Brooklyn, and we conducted surveys on people in the neighborhood. </p>
            </div>
            <figure class="p-div-block-r" style="width: 50%">
                <img class="" src="images/uxreserchUXClassAsset%201.png">
                <figcaption>Interviewing patrons of a similar exhibit at the Brooklyn Museum</figcaption>
            </figure>
        </div>
    </div>
